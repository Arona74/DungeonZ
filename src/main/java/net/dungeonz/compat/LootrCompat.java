...
public class LootrCompat {
    ...
    private static final Block LOOTR_CHEST = Registries.BLOCK.get(Identifier.of("lootr", "lootr_chest"));
    private static final Block LOOTR_TRAPPED_CHEST = Registries.BLOCK.get(Identifier.of("lootr", "lootr_trapped_chest"));
    private static final Block LOOTR_BARREL = Registries.BLOCK.get(Identifier.of("lootr", "lootr_barrel"));
    ...
    public static void convertToLootrChest(ServerWorld world, BlockPos pos, String lootTableString) {
        ...
        if (blockEntity instanceof LootableContainerBlockEntity lootableContainer) {
            lootableContainer.setLootTable(RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.of(lootTableString)));
        }
    }
