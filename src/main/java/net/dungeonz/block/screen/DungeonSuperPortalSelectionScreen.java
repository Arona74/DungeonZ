...
public class DungeonSuperPortalSelectionScreen extends Screen {
    ...
    private static final Identifier TEXTURE = Identifier.of("dungeonz:textures/gui/dungeon_selection.png");
    ...
    protected void init() {
        ...
        this.selectButton = this.addDrawableChild(ButtonWidget.builder(Text.translatable("text.dungeonz.super_portal.select"), button -> {
            this.onDone();
    ...
    private class WidgetButtonPage extends ButtonWidget {
        ...
        public void renderTooltip(DrawContext context, int mouseX, int mouseY) {
            if (this.hovered && this.index + DungeonSuperPortalSelectionScreen.this.indexStartOffset < DungeonSuperPortalSelectionScreen.this.dungeonIds.size()) {
                Text text = Text.translatable("dungeon." + DungeonSuperPortalSelectionScreen.this.dungeonIds.get(this.index + DungeonSuperPortalSelectionScreen.this.indexStartOffset));
